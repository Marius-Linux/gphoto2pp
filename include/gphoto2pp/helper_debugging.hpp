...
namespace detail {
struct PortLoggingEventsManager
    : observer::SubjectEvent<LogLevelWrapper, void(LogLevelWrapper const &, std::string const &,
...
subscribeToPortLogEvents(const LogLevelWrapper &event,
