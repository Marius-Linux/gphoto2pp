 ...
 * GPhoto2pp::CameraWidgetTypeWrapper::Menu or GPhoto2pp::CameraWidgetTypeWrapper::Radio
 */
...
public:
     ...
     * \throw GPhoto2pp::exceptions::IndexOutOfRange if the index is greater than countChoices of
     * choices \throw GPhoto2pp::exceptions::gphoto2_exception
     */
    int getChoice() const;
     ...
     * \note Helper which calls getChoice with the provided index and then setValue with the
     * response \throw GPhoto2pp::exceptions::IndexOutOfRange if the index is greater than
     * countChoices \throw GPhoto2pp::exceptions::gphoto2_exception
     */
