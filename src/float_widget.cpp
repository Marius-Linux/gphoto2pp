...
FloatWidget::FloatWidget(gphoto2::_CameraWidget *cameraWidget) : ValueWidgetBase{cameraWidget} {}
...
void FloatWidget::setValue(float const &value) {
    gphoto2pp::checkResponse(gphoto2::gp_widget_set_value(m_cameraWidget, &value),
                             "gp_widget_set_value");
}
} // namespace gphoto2pp
