...
CameraAbilitiesListWrapper::CameraAbilitiesListWrapper() : m_cameraAbilitiesList{nullptr} {
    FILE_LOG(logINFO) << "CameraAbilitiesListWrapper Constructor";

    gphoto2pp::checkResponse(gphoto2::gp_abilities_list_new(&m_cameraAbilitiesList),
                             "gp_abilities_list_new");

    auto spContext = gphoto2pp::getContext();

    gphoto2pp::checkResponse(
        gphoto2::gp_abilities_list_load(m_cameraAbilitiesList, spContext.get()),
...
CameraAbilitiesListWrapper::~CameraAbilitiesListWrapper() {
    ...
    if (m_cameraAbilitiesList != nullptr) {
        gphoto2pp::checkResponseSilent(gphoto2::gp_abilities_list_free(m_cameraAbilitiesList),
...
CameraAbilitiesListWrapper &CameraAbilitiesListWrapper::
operator=(CameraAbilitiesListWrapper &&other) {
    ...
    if (this != &other) {
        ...
        if (m_cameraAbilitiesList != nullptr) {
            FILE_LOG(logINFO)
                << "CameraAbilitiesListWrapper move assignment - current abilities is not null";
            gphoto2pp::checkResponse(gphoto2::gp_abilities_list_free(m_cameraAbilitiesList),
                                     "gp_abilities_list_free");
        }
...
CameraListWrapper
CameraAbilitiesListWrapper::listDetect(GPPortInfoListWrapper const &portInfoList) {
    auto spContext = gphoto2pp::getContext();
    CameraListWrapper cameraList;

    gphoto2pp::checkResponse(
        gphoto2::gp_abilities_list_detect(m_cameraAbilitiesList, portInfoList.getPtr(),
                                          cameraList.getPtr(), spContext.get()),
...
void CameraAbilitiesListWrapper::reset() {
    gphoto2pp::checkResponse(gphoto2::gp_abilities_list_reset(m_cameraAbilitiesList),
...
int CameraAbilitiesListWrapper::count() const {
    ...
    return gphoto2pp::checkResponse(gphoto2::gp_abilities_list_count(m_cameraAbilitiesList),
...
int CameraAbilitiesListWrapper::lookupModel(std::string const &model) const {
    ...
    return gphoto2pp::checkResponse(
        gphoto2::gp_abilities_list_lookup_model(m_cameraAbilitiesList, model.c_str()),
