...
DateWidget::DateWidget(gphoto2::_CameraWidget *cameraWidget) : ValueWidgetBase{cameraWidget} {
...
void DateWidget::setValue(std::time_t const &datetime) {
    ...
    gphoto2pp::checkResponse(gphoto2::gp_widget_set_value(m_cameraWidget, &temp),
                             "gp_widget_set_value");
}
} // namespace gphoto2pp
